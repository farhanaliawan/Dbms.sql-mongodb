...
public class AddsEmployee extends JFrame implements ActionListener {
    ...
    AddsEmployee() {
        ...
        JLabel labelaadhar = new JLabel("Cnic Number");
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == add) {
            ...
            String education = Objects.requireNonNull(cbeducation.getSelectedItem()).toString();
            String designation = tfdesignation.getText();
            String aadhar = tfaadhar.getText();
            String empId = lblempId.getText();

            try {
                conn1 conn = new conn1();  // Using the correct connection class
                MongoDatabase database = conn.getDatabase();
                MongoCollection<Document> collection = database.getCollection("employee");

                Document employee = new Document("name", name)
                        .append("fatherName", fname)
